        ...
        <div className='flex flex-col items-center justify-between px-10 md:flex-row md:pt-10'>
          <div>
            <div className='p-10'>
              ...
              <p className='text-sm md:text-lg py-2 md:py-4 text-slate-300 leading-4'>Originally from San Francisco, California, I&apos;m currently making cool stuff in Atlanta, Georgia.</p>
            </div>
