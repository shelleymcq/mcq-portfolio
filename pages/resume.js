    ...
    <div className="bg-cyan-900 min-h-screen flex flex-col">
      ...
      <div className="bg-slate-100 flex flex-col shadow-2xl rounded-xl m-2 p-3 md:m-4 lg:m-10 lg:p-10">
        <p className="px-6 text-slate-900 text-sm md:text-base lg:text-lg">
          ...
          written code to customize list virtualization when no existing
          JavaScript library would work out-of-the-box. In February I became
        ...
        <p className="px-6 py-2 text-slate-900 text-sm md:text-base lg:text-lg">
          ...
          collaboration and effective communication are essential. I have
          experience collaborating with remote teams around the world and am
          comfortable with tools such as JIRA. Additionally, I have experience
          with Agile methodologies, pair programming, reviewing pull requests,
          and providing constructive feedback to team members. Then there&apos;s
