    ...
    <div>        
      <div  className='bg-cyan-900 flex flex-col'>
        ...
        <div className='flex justify-evenly flex-wrap p-5'>
          ...
          <div className='shadow-2xl p-10 rounded-xl m-5 md:w-1/3 md:p-5 lg:w-1/4'>
            <Image src={temperature} alt='temperature visualization site thumbnail' />
            <div className='flex justify-around pt-3'>
              <Link href='https://github.com/shelleymcq/temperature' target='_blank' rel='noopener noreferrer' className='px-2 pb-1 bg-cyan-700 text-slate-200 rounded-md  hover:bg-cyan-600'>the repo</Link>
              <Link href='https://temperature-ivory.vercel.app/' target='_blank' rel='noopener noreferrer' className='px-2 pb-1 bg-cyan-700 text-slate-200 rounded-md hover:bg-cyan-600'>the app</Link>
            </div>
            <p className='p-4 text-slate-300 text-xs md:text-sm lg:text-base'>A tool for crafty users to ﬁnd the daily high temperatures for a given US city in a particular year.</p>
            <h4 className='text-cyan-600 text-sm font-medium pt-5'>Tech used</h4>
            <p className='text-slate-300 text-sm'>React | NextJS | TailwindCSS</p>
          </div>
          <div className='shadow-2xl p-10 rounded-xl m-5 md:w-1/3 md:p-5 lg:w-1/4'>
