...
const About = () => {
  return (     
    <div  className='bg-rose-900 min-h-screen flex flex-col'>
      ...
      <div className='shadow-2xl rounded-xl m-2 p-3 md:m-4 lg:m-10 lg:p-10'>
        <p className="px-6 text-slate-300 text-sm md:text-base lg:text-lg">While I have left the high school chemistry classroom behind, I will always be a teacher. That part of me has influenced my wish to collaborate on a team of like-minded folks committed to creating applications and experiences for learners and information seekers who want to make the world, and web, a more beautiful and accessible place.</p>
